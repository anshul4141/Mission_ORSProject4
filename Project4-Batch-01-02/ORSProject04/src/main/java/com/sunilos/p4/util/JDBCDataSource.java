...
public final class JDBCDataSource {
	...
	public static JDBCDataSource getInstance() {
		if (datasource == null) {
			...
			datasource.cpds.setInitialPoolSize(1);
			datasource.cpds.setAcquireIncrement(1);
			datasource.cpds.setMaxPoolSize(5);
			datasource.cpds.setMaxIdleTime(10);
			datasource.cpds.setMinPoolSize(1);
