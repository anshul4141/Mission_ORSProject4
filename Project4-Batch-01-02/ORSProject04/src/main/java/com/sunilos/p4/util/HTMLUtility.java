 ...
 * 
 * boolean select = true; if (select) { sb.
 * append("<option selected value=''>--------------Select Gender---------------</option>"
 * ); }
 * 
 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * if (key.trim().equals(selectedVal)) { sb.append("<option selected value='" +
		 * key + "'>" + val + "</option>"); } else { sb.append("<option value='" + key +
		 * "'>" + val + "</option>"); } } sb.append("</select>"); return sb.toString();
		 * }
		 * 
		 * }
